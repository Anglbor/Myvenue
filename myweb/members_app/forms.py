...
class RegisterUserForm(UserCreationForm):
    ...
    def __int__(self, *args, **kwargs):
        ...
        self.fields['username'].widget.attrs['class'] = 'class-control'
        self.fields['password1'].widget.attrs['class'] = 'class-control'
        self.fields['password2'].widget.attrs['class'] = 'class-control'
